...
int main()
{
	FILE *fa, *fb;
    int ca, cb;
    fa = fopen("/home/student/Desktop/SoumyadeepA28/week3/inp.c", "r");
    if (fa == NULL){
        printf("Cannot open file \n");
        exit(0);
    }

    fb = fopen("/home/student/Desktop/SoumyadeepA28/week3/q4out5.c", "w+");
    ca = getc(fa);
	while (ca != EOF){
		if(ca==' ')
		{
	...
	fclose(fa);
	fclose(fb);
	fa = fopen("/home/student/Desktop/SoumyadeepA28/week3/q4out5.c", "r");
	if(fa == NULL){
		printf("Cannot open file");
		return 0;
	}
	...
	fclose(fb);
	remove("temp.c");
	f1=fopen("/home/student/Desktop/SoumyadeepA28/week3/q4out5.c","r");
	if(f1==NULL)
	{
